...
@Component({
    selector: 'organization-unit-department-members',
    templateUrl: "./organization-unit-department-members.component.html"
})
export class OrganizationUnitDepartmentMembersComponent extends AppComponentBase implements OnInit {
    ...
    private _organizationUnit: IBasicOrganizationUnitDepartmentInfo = null;
    ...
    get organizationUnit(): IBasicOrganizationUnitDepartmentInfo {
        return this._organizationUnit;
    }

    set organizationUnit(ou: IBasicOrganizationUnitDepartmentInfo) {
