...
@Component({
    selector: 'createOrEditOrganizationUnitDepartmentModal',
    templateUrl: './create-or-edit-unit-department-modal.component.html'
})
export class CreateOrEditUnitDepartmentModalComponent extends AppComponentBase {
