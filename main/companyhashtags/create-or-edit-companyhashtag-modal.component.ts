...
@Component({
    selector: 'createOrEditCompanyHashtagModal',
    templateUrl: './create-or-edit-companyhashtag-modal.component.html'
})
export class CreateOrEditCompanyHashtagModalComponent extends AppComponentBase {

    @ViewChild('companyHashtagNameInput') companyHashtagNameInput: ElementRef;
    ...
    onShown(): void {
        $(this.companyHashtagNameInput.nativeElement).focus();
